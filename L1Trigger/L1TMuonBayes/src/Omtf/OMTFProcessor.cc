    ...
    /*if( this->myOmtfConfig->fwVersion() >= 5 ) {
      ...
      if (
        ...
        quality = 1;
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000010100000001").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000100000000010001").to_ulong()
         ...
         quality = 4;
      else if(abs(myCand->getEtaHw()) == 110 &&
           (   static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("010000000110000000").to_ulong()
            || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("100000000110000000").to_ulong()
