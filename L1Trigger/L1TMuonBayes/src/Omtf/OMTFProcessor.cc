  ...
  for(auto& myCand: algoCands) {
    ...
    if( this->myOmtfConfig->fwVersion() >= 6 ) { //TODO fix the fwVersion
      if (   static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000110000000001").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000010000010100").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000110001000000").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000010110000000101").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("011011100000001100").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000100000000011").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000011010000000").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("001000010001000000").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000011000000110100").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000011100000011100").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000110110000110101").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("001001000001000000").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("001001010001000000").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("001001010001000001").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000010000001101").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000010000010001").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("001100010000001111").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("101000010110000000").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000101000000110000").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000100000010001").to_ulong()
        ...
        if(    static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000100000000011111").to_ulong()
        ...
        if(    static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000001110001000011").to_ulong()
            || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000111000000000100").to_ulong()
            ...
            || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000101000000110100").to_ulong()
            || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000100000110000").to_ulong()
