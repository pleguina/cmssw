  ...
  for(auto& myCand: algoCands) {
    ...
    if( this->myOmtfConfig->fwVersion() >= 6 ) { //TODO fix the fwVersion
      if (   static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000110000000001").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000000100110000001").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000001010000000111").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000100010000110000").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("010001010010000000").to_ulong()
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("011000001011000000").to_ulong()
          ...
          || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000100000000011111").to_ulong()
        ...
        if(
            ...
            || static_cast<unsigned int>(myCand->getFiredLayerBits()) == std::bitset<18>("000011010000000111").to_ulong()
