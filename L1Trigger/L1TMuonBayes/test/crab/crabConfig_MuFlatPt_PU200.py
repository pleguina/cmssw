...
config.General.requestName = 'muCorr_MC_analysis_MuFlatPt_PU200_v1'
...
config.Data.outputDatasetTag = 'CRAB3_muCorr_MC_analysis_MuFlatPt_PU200_v1'
config.Data.totalUnits = 100 #75
