...
config.General.requestName = 'muCorr_MC_analysis_SingleNeutrino_PU200_v1_t9'
...
config.Data.outputDatasetTag = 'CRAB3_muCorr_MC_analysis_SingleNeutrino_PU200_v1_t9'
