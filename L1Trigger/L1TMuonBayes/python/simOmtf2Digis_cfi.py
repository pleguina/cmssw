...
simOmt2fDigis = cms.EDProducer("L1TMuonBayesOmtf2TrackProducer",
  ...
  minDtPhQuality = cms.int32(4),
  
  #ptModuleFile = cms.FileInPath("L1Trigger/L1TMuonBayes/test/ptModuleLut2D_GenMean.xml"),
