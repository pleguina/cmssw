...
public:
  ...
  //loating point version
  int extrapolateDtPhiB(const int& refLogicLayer, const int& refPhi, const int& refPhiB,
  ...
  int extrapolateDtPhiBFP(const int& refLogicLayer, const int& refPhi, const int& refPhiB,
      unsigned int targetLayer, const int& targetStubPhi, const int& targetStubQuality, const int& targetStubEta, const int& targetStubR, const OMTFConfiguration* omtfConfig);
  ...
  void processInput(unsigned int iProcessor, l1t::tftype mtfType, const OMTFinput& aInput,
