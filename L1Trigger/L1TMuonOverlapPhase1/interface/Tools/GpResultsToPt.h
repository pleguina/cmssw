...
public:
  ...
  const std::vector<std::vector<double> >& getGpResultsToPtLuts() const {
    return gpResultsStatLuts;
  }

  void setGpResultsToPtLuts(
      const std::vector<std::vector<double> > &gpResultsToPtLuts) {
