...
config.General.requestName = type + '_MC_analysis_ZprimeToMuMu_PU140_v3_t100'
...
config.Data.outputDatasetTag = 'CRAB_' + type + '_MC_analysis_ZprimeToMuMu_PU140_v3_t100'
