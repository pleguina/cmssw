...
config.General.requestName = 'omtf_nn_MC_analysis_SingleNeutrino_PU300_v2_t39'
...
config.Data.outputDatasetTag = 'CRAB3_omtf_nn_MC_analysis_SingleNeutrino_PU300_v2_t39'
config.Data.totalUnits = 1915
