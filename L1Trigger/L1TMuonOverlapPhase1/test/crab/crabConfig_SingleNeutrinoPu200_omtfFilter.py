...
config.General.requestName = 'omtf_nn_MC_analysis_SingleNeutrino_PU200_v3_t107'
...
config.JobType.psetName = 'runMuonOverlapFilter.py'
...
config.Data.outputDatasetTag = 'CRAB3_omtf_nn_MC_analysis_SingleNeutrino_PU200_v3_t107'
