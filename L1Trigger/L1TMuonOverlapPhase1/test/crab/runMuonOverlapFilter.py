...
process = cms.Process("L1TMuonEmulationOmtf0x0012")
import os
import sys
import commands
...
if verbose: 
    process.MessageLogger = cms.Service("MessageLogger",
       ...
       debugModules = cms.untracked.vstring('L1MuonOmtfCandsFilter', 'simOmtfPhase1Digis') 
...
process.L1MuonOmtfCandsFilter= cms.EDFilter("L1MuonOmtfCandsFilter", 
                                 ...
                                 qualityCut = cms.int32(8), 
                                 hwPtCut  = cms.int32(36)
                                        )

#process.L1MuonOmtfCandsFilterPath = cms.Path(process.L1MuonAnalyzerOmtf)
...
process.out = cms.OutputModule("PoolOutputModule", 
   fileName = cms.untracked.string("l1tomtf_filteredEvents.root"),
   
   SelectEvents = cms.untracked.PSet( 
        SelectEvents = cms.vstring("L1TMuonPath")
    ),
...
process.L1TMuonPath = cms.Path(process.L1TMuonSeq + process.L1MuonOmtfCandsFilter)
