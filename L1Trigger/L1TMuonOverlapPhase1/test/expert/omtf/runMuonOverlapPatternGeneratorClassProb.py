...
if verbose: 
    process.MessageLogger = cms.Service("MessageLogger",
       ...
       omtfEventPrint = cms.untracked.PSet(    
                         filename  = cms.untracked.string('Patterns_0x00012_oldSample_3_30Files_grouped1_classProb16_recalib2'),
...
process.simOmtfPhase1Digis.optimisedPatsXmlFile = cms.string("Patterns_0x00012_oldSample_3_30Files_grouped1_classProb16_recalib2.xml")
