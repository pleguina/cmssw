...
if verbose: 
    process.MessageLogger = cms.Service("MessageLogger",
       ...
       omtfEventPrint = cms.untracked.PSet(    
                         filename  = cms.untracked.string('Patterns_0x00012_oldSample_3_30Files_classProb1_recalib'),
...
process.simOmtfPhase1Digis.optimisedPatsXmlFile = cms.string("Patterns_0x00012_oldSample_3_30Files_classProb1_recalib.xml")
