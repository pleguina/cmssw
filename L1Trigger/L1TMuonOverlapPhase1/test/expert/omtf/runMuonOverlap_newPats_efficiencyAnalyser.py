...
if verbose: 
    process.MessageLogger = cms.Service("MessageLogger",
       ...
       omtfEventPrint = cms.untracked.PSet(    
                         filename  = cms.untracked.string('log_MuonOverlap_newPats_75'),
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('omtfAnalysis2_eff_SingleMu_t75' + '.root'), closeFileFast = cms.untracked.bool(True) )
...
process.simOmtfPhase1Digis.eventCaptureDebug = cms.bool(verbose)
