...
TrackingTriggerTrack::TrackingTriggerTrack(edm::Ptr<TTTrack<Ref_Phase2TrackerDigi_> >& ttTrackPtr, bool fromdigitisedValues)
...
std::ostream& operator<<(std::ostream& out, const TrackingTriggerTrack& ttTrack) {
  out << "ttTrack: "
      ...
      << " | "
      <<" rInv "<< std::setw(13)<<ttTrack.rInv
      << " | eta " << std::setw(5) << ttTrack.eta << " hw " << std::setw(5) << ttTrack.etaHw << " bin " << std::setw(3)
      << ttTrack.etaBin << " | "
