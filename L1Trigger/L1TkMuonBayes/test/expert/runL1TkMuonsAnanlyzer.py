...
process.TFileService = cms.Service("TFileService", fileName = cms.string('muCorrelatorTTAnalysis1_Mu_FlatPt2to100_NoPU_L1TkMuons.root'), closeFileFast = cms.untracked.bool(True))
