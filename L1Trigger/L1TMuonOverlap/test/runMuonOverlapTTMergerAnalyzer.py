...
process.omtfTTAnalyzer= cms.EDAnalyzer("OmtfTTAnalyzer", 
                                 outRootFile = cms.string("omtfTTAnalysis.root"),
...
process.schedule = cms.Schedule(process.TTClusterStubTruth, process.TTTracksWithTruth, process.L1TMuonPath, process.omtfTTAnalyzerPath)
