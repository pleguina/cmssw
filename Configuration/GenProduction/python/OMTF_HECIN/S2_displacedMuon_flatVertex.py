...
Key properties:
  ...
  Lxy: up to 500 cm (muon exits tracker if Lxy > ~110 cm at |eta|<1.24;
       stubs still recorded in DT barrel at r=231-500 cm).
...
generator = cms.EDProducer("FlatRandomPtGunProducer2",
    PGunParameters = cms.PSet(
        ...
        MaxLxy          = cms.double(500.0),          # [cm] allow displaced vertex inside MB3
